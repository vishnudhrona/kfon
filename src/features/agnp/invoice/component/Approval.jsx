...
import { fetchApprovalTableData } from '../action';
import { getApprovalTableData } from '../selector';

const Approval = ({ tableData }) => {
  ...
  return (
    <>
      <Headline headName={t('agnpInvoiceApproval')} />
...
const mapStateToProps = (state) => ({
  approvalTableData: getApprovalTableData(state)
});

const mapDispatchToProps = {
  tableData: fetchApprovalTableData
};

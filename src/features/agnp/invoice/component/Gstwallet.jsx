...
import { fetchGstWalletTableData } from '../action';
import { getGstWalletTableData } from '../selector';

const Gstwallet = ({ tableData }) => {
...
const mapStateToProps = (state) => ({
  gstWalletTableData: getGstWalletTableData(state)
});

const mapDispatchToProps = {
  tableData: fetchGstWalletTableData
};

export default connect(mapStateToProps, mapDispatchToProps)(Gstwallet);

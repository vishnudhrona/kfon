...
import { fetchLnpRevenuTableData } from '../action';
import { getLnpRevenueTableData } from '../selector';

const Lnprevenue = ({ tableData }) => {
  ...
  return (
    <>
      <Headline headName={t('lnpRevenue')} />
...
const mapStateToProps = (state) => ({
  lnpRevenueTableData: getLnpRevenueTableData(state)
});

const mapDispatchToProps = {
  tableData: fetchLnpRevenuTableData
};

export default connect(mapStateToProps, mapDispatchToProps)(Lnprevenue);

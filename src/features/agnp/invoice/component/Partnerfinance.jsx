...
import { fetchPartnerFinanceTableData } from '../action';
import { getPartnerFinanceTableData } from '../selector';

const Partnerfinance = ({ tableData }) => {
  ...
  return (
    <>
      <Headline headName={t('partnerFinance')} />
...
const mapStateToProps = (state) => ({
  partnerFinanceTableData: getPartnerFinanceTableData(state)
});

const mapDispatchToProps = {
  tableData: fetchPartnerFinanceTableData
};

export default connect(mapStateToProps, mapDispatchToProps)(Partnerfinance);

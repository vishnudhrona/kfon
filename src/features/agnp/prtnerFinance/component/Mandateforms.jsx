...
import { fetchMandateFormTableData } from '../action';
import { getMandateFormTableData } from '../selector';

const Mandateforms = ({ tableData }) => {
  ...
  return (
    <>
      <Headline headName={t('mandateFormsList')} />
...
const mapStateToProps = (state) => ({
  manDateTableData: getMandateFormTableData(state)
});

const mapDispatchToProps = {
  tableData: fetchMandateFormTableData
};

export default connect(mapStateToProps, mapDispatchToProps)(Mandateforms);

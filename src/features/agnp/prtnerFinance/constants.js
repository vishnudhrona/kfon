export const STATE_REDUCER_KEY = 'agnp-franchisees';
...
export const VISIBLE_COLUMNS_LNP_LIST = [
  { header: 'Sl No', accessor: 'slno' },
  { header: 'Partner Id', accessor: 'partnerId' },
  { header: 'Company Name', accessor: 'companyName' },
  { header: 'FE Name', accessor: 'feName' },
  { header: 'Contact', accessor: 'contact' },
  { header: 'Location Category', accessor: 'locationCategory' },
...
export const VISIBLE_COLUMNS_AGNP_LIST = [
  { header: 'Sl No', accessor: 'slno' },
  { header: 'Partner Id', accessor: 'partnerId' },
  { header: 'Company Name', accessor: 'companyName' },
  { header: 'Contact', accessor: 'contact' },
  { header: 'Address', accessor: 'address' },
  { header: 'GSTIN', accessor: 'gstin' },
  { header: 'GST Verified Date', accessor: 'gstVerifiedDate' },
  { header: 'District', accessor: 'district' },
  { header: 'State', accessor: 'state' },
  { header: 'Pincode', accessor: 'pincode' },
  { header: 'BU-OE Bank Approval', accessor: 'buOeBankApproval' },
  { header: 'BU-Head Approval Date', accessor: 'buHeadApprovalDate' }
];
...
export const transformRowToPreviewData = (data, t, handlers = {}) => {
  ...
  const dynamicFields = [
    ...
    { label: 'popName', value: agreementDetails.popName ?? '-' },

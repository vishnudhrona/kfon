...
const CircuitProvisioningCard = ({ data, index }) => {
    ...
    const handleNavigate = () => {
        router.navigate({
            to: '/app/corporate/circuit-provisioning-list/$enquiryId',
...
const CorporateCircuitProvisioningSummaryList = () => {
    const { t } = useTranslation();
...
export default CorporateCircuitProvisioningSummaryList;

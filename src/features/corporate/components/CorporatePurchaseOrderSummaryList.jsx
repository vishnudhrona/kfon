...
const PurchaseOrderCard = ({ data, index }) => {
            ...
            >
                <HStack w="full" spacing={3} align="center" position="relative">
                    ...
                    <VStack flex={1} minW={0} align="stretch" spacing={2}>
                        {/* Row 1: ID badge | Company + type | (verified) | spacer | PO Status | Arrow */}
...
const CorporatePurchaseOrderSummaryList = () => {
    const { t } = useTranslation();
...
export default CorporatePurchaseOrderSummaryList;

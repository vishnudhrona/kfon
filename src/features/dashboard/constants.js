export const STATE_REDUCER_KEY = 'dashboard-key';
...
export const MALAYALAM_MESSAGES = {
  bplFormClosedMessage: "നമസ്കാരം! BPL ഉപഭോക്താക്കൾക്കായുള്ള രജിസ്ട്രേഷൻ ഇപ്പോൾ അവസാനിച്ചിരിക്കുന്നു. കണക്ഷൻ വേണ്ടി ഇപ്പോൾ അപേക്ഷിച്ചിരിക്കുന്നവർക്ക് മുന്നാം ഘട്ടത്തിൽ കണക്ഷൻ ലഭിക്കുന്നതായിരിക്കും.",
  lnpNoticeTitle1: "പ്രവൃത്തി -1:",
  lnpNoticeContent1: "GST നമ്പർ KFON പോർട്ടലിൽ അപ്ഡേറ്റ് ചെയ്തിരിക്കുന്ന എല്ലാ LNPകളും നിങ്ങളുടെ കഴിഞ്ഞ ഫിനാൻഷ്യൽ ഇയർ (2024-25) ഏപ്രിൽ 2024 മുതൽ നിങ്ങൾക്ക് KFONൽ നിന്നും ലഭിച്ച റവന്യൂ കമ്മീഷന്റെ എല്ലാ മാസത്തെയും ബില്ലുകൾ നിങ്ങളുടെ ഓഡിറ്ററുടെയും, GST ഫയൽ ചെയ്യുന്ന ഏജൻസിയുടെയും സഹായത്തോടെ നിങ്ങളുടെ GST പോർട്ടലിൽ (GSTR-1) ഫയൽ ചെയ്തിട്ടുണ്ട് എന്ന് ഉറപ്പുവരുത്തുക.",
  lnpNoticeTitle2: "പ്രവൃത്തി -2:",
  lnpNoticeContent2: "GST നമ്പർ KFON പോർട്ടലിൽ അപ്ഡേറ്റ് ചെയ്തിരിക്കുന്ന എല്ലാ LNP-കളും കഴിഞ്ഞ ഫിനാൻഷ്യൽ ഇയർ-ലെ ബില്ലുകൾ GST-1 ൽ ഫയൽ ചെയ്തിട്ടുണ്ട് എന്ന് ഉറപ്പാക്കിയതിന് ശേഷം നിങ്ങളുടെ KFON Partner പോർട്ടലിൽ കയറി താഴെ കൊടുത്തിരിക്കുന്ന ഡോക്യുമെന്റിലെ നിർദ്ദേശങ്ങൾ അനുസരിച്ച് നിങ്ങളുടെ KFON റവന്യൂ കമ്മീഷന്റെ എല്ലാ മാസത്തെയും ബില്ലുകളുടെ വിശദാംശങ്ങൾ എത്രയും പെട്ടെന്ന് തന്നെ അപ്ഡേറ്റ് ചെയ്യുക.",
  lnpNoticeTitle3: "പ്രവൃത്തി -3:",
  lnpNoticeContent3: "GST രജിസ്ട്രേഷൻ ഉണ്ടായിട്ടും ഇതുവരെ KFON പോർട്ടലിൽ GST നമ്പർ അപ്ഡേറ്റ് ചെയ്യാത്ത LNP-കൾ ഉണ്ടെങ്കിൽ എത്രയും പെട്ടെന്ന് നിങ്ങളുടെ GST സർട്ടിഫിക്കറ്റിന്റെ കോപ്പിയും PAN നമ്പറിന്റെ കോപ്പിയും അറ്റാച്ച് ചെയ്ത് നിങ്ങളുടെ KFON പാർട്ണർ പോർട്ടലിൽ ഒരു പുതിയ ടിക്കറ്റ് (Subject : GSTIN Update) രജിസ്റ്റർ ചെയ്ത് നിങ്ങളുടെ GSTIN നമ്പർ അപ്ഡേറ്റ് ചെയ്യുക. എന്നാൽ മാത്രമേ നിങ്ങൾക്ക് മുകളിലെ പറഞ്ഞിരിക്കുന്നത് പോലെ KFONൽ നിന്നും നിങ്ങളുടെ GST തുക വാലറ്റിലേക്ക് ലഭിക്കുകയുള്ളൂ. നിങ്ങളുടെ GST നമ്പറും PAN നമ്പറും പോർട്ടലിൽ അപ്ഡേറ്റ് ചെയ്തിട്ടുണ്ടോ എന്ന് അറിയുന്നതിനായി ഇവിടെ ക്ലിക്ക് ചെയ്യുക. പുതിയ ടിക്കറ്റ് ക്രിയേറ്റ് ചെയ്യുവാൻ ആയി ഇവിടെ ക്ലിക്ക് ചെയ്യുക.",
  lnpNoticeLink1: "പുതിയ ടിക്കറ്റ് ക്രിയേറ്റ് ചെയ്യുവാൻ ഇവിടെ ക്ലിക്ക് ചെയ്യുക.",
  lnpNoticeLink2: "ഇതിനുള്ളിൽ ഇതെല്ലാം ചെയ്തിരിക്കുന്ന LNP-കൾ ഇനി വരിക്കുമ്പോൾ ഇവ പോലെ സ്റ്റേറ്റ് ചെയ്യേണ്ട ആവശ്യം ഇല്ല.",
  lnpNoticeDoc1: "ഡോക്യുമെന്റ് -1 : റീട്ടെയിൽ കസ്റ്റമേഴ്‌സിന്റെ റവന്യൂ കമ്മീഷന്റെ ബില്ലുകൾ അപ്ഡേറ്റ് ചെയ്യാനുള്ള നിർദ്ദേശങ്ങൾ കിട്ടുവാൻ ഇവിടെ ക്ലിക്ക് ചെയ്യുക.",
  lnpNoticeDoc2: "ഡോക്യുമെന്റ് -2 : എന്റർപ്രൈസ് കസ്റ്റമേഴ്‌സിന്റെ റവന്യൂ കമ്മീഷന്റെ ബില്ലുകൾ അപ്ഡേറ്റ് ചെയ്യാനുള്ള നിർദ്ദേശങ്ങൾ കിട്ടുവാൻ ഇവിടെ ക്ലിക്ക് ചെയ്യുക."
};

...
import { fetchMainServices } from "../../action";
import MainServicePopup from "../../pop-up/MainServicePopup";
import { getMainServicesData } from "../../selector";
import ServiceCard from "./ServiceCard";

const { UserAdd } = Icons;

const TABLE_KEY = SERVER_SIDE_TABLE_KEYS.MAIN_SERVICES_TABLE;
...
const MainServices = () => {
    ...
    const mainServicesData = useSelector(getMainServicesData);
    ...
    const getList = useCallback((params = {}) => {
        dispatch(fetchMainServices({ key: TABLE_KEY, type, ...params }));
    }, [dispatch, type]);
        ...
        <>
            <VStack alignItems={'stretch'} h='full' gap='2'>
                ...
                <Box
                    ...
                    p={4}
                >
                    <ServiceCard mainServices={mainServicesData} pageOffset={pageOffset} onEdit={handleEdit} />
                </Box>
            ...
            <MainServicePopup isOpen={open} handleClose={handleClose} data={editData} />
        </>
    )
}
